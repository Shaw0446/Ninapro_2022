...
def Sep12Data(data):
    ...
    # 重塑成（sample，1）
    data1 = data1.reshape(-1, 20, 1)
    data2 = data2.reshape(-1, 20, 1)
    data3 = data3.reshape(-1, 20, 1)
    data4 = data4.reshape(-1, 20, 1)
    data5 = data5.reshape(-1, 20, 1)
    data6 = data6.reshape(-1, 20, 1)
    data7 = data7.reshape(-1, 20, 1)
    data8 = data8.reshape(-1, 20, 1)
    data9 = data9.reshape(-1, 20, 1)
    data10 = data10.reshape(-1, 20, 1)
    data11 = data11.reshape(-1, 20, 1)
    data12 = data12.reshape(-1, 20, 1)
