...
def BConv(layer):
    x = KL.Conv1D(filters=128, kernel_size=5, strides=1, padding='same')(layer)
    x = KL.Activation('relu')(x)
    x = KL.BatchNormalization()(x)
    x = KL.Conv1D(filters=256, kernel_size=5, strides=1, padding='same')(x)
    x = KL.Activation('relu')(x)
    x = KL.BatchNormalization()(x)
    x = KL.Conv1D(filters=128, kernel_size=5, strides=1, padding='same')(x)
    x = KL.Activation('relu')(x)
    x = KL.BatchNormalization()(x)
    return x
...
def DownAway12reluBNCNN1D():
    input1 = KL.Input(shape=(20, 1))
    input2 = KL.Input(shape=(20, 1))
    input3 = KL.Input(shape=(20, 1))
    input4 = KL.Input(shape=(20, 1))
    input5 = KL.Input(shape=(20, 1))
    input6 = KL.Input(shape=(20, 1))
    input7 = KL.Input(shape=(20, 1))
    input8 = KL.Input(shape=(20, 1))
    input9 = KL.Input(shape=(20, 1))
    input10 = KL.Input(shape=(20, 1))
    input11 = KL.Input(shape=(20, 1))
    input12 = KL.Input(shape=(20, 1))
