...
if __name__ == '__main__':
    for j in range(1, 2):
        file = h5py.File('F:/DB2/Part/DB2_s' + str(j) + 'SegZsc.h5', 'r')
        ...
        Xtest1, Xtest2, Xtest3 = Sep3Data(X_test)

        model = keras.models.load_model('F:/DB2/model/Away3reluBNCBAMcatNEW/111'
                                      '/DB2_s' + str(j) + '6segPart.h5')
