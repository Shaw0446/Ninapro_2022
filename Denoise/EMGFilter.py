...
if __name__ == '__main__':
    for j in range(1, 2):
        df1 = pd.read_hdf(dir+'/data/stimulus/raw/DB2_s' + str(j) + 'raw.h5', 'df')
        ...
        # 存储为h5文件
        dfemg_notch.to_hdf(dir+'/data/stimulus/filter/DB2_s' + str(j) + 'filter.h5', format='table',key='df', mode='w', complevel=9, complib='blosc')
